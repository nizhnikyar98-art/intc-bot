...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Привет! Я бот для обработки ваших обращений.")
    # Отправляем второе сообщение сразу следом
    await update.message.reply_text("Назовите ваш вопрос")
